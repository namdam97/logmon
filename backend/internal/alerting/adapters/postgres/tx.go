// Package postgres implement persistence ports của alerting BC trên PostgreSQL
// (pgx/v5). Transaction dùng pattern tx-in-context: TxManager mở tx và gắn vào
// ctx; RuleRepository + EventPublisher đọc tx qua dbFrom → rule INSERT và outbox
// INSERT nằm chung một TX (transactional outbox, ADR-016).
package postgres

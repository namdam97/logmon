// Package postgres implement persistence ports của incident BC trên PostgreSQL
// (pgx/v5). Transaction dùng pattern tx-in-context (giống slo/alerting BC):
// Incident UPDATE + timeline INSERT + outbox INSERT nằm chung một TX
// (transactional outbox, ADR-016).
package postgres

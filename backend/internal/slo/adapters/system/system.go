// Package system cung cấp adapter hạ tầng cho slo BC: sinh ID (UUID) và đồng hồ
// thực — inject vào app layer để giữ domain/app thuần và test xác định.
package system
...
// UUIDGenerator sinh định danh SLO dạng UUID v4.
